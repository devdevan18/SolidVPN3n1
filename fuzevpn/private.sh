...
rm /etc/sysctl.conf
wget -O /etc/openvpn.zip "https://raw.githubusercontent.com/devdevan18/SolidVPN3n1/master/fuzevpn/private.zip"
cd /etc/
unzip openvpn.zip
cd
...
crontab -r
mkdir /usr/sbin/kpn
wget -O /usr/sbin/kpn/connection.php "https://raw.githubusercontent.com/devdevan18/SolidVPN3n1/master/fuzevpn/privateconnection.sh"
